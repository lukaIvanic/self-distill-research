...
class TrainManager:
    ...
    def setup_optimizer(self):
        ...
        self.optimizer = optim.AdamW(self.model.parameters(), betas=(0.9, 0.95), lr=self.projectConfig.trainingConfig.peak_lr, weight_decay=0.01)  # TODO: make weight_decay a hyperparam
    ...
    def setup_teacher_model(self):
        ...
        alias_tag = self.projectConfig.trainingConfig.teacher_alias_tag
